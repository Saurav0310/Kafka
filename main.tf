...
resource "confluent_private_link_access" "aws" {
  ...
  network {
    ...
    confluent_role_binding.app-consumer-developer-read-from-group,
    confluent_role_binding.app-consumer-developer-read-from-topic,
    confluent_role_binding.app-manager-kafka-cluster-admin,
    confluent_role_binding.app-producer-developer-write,
